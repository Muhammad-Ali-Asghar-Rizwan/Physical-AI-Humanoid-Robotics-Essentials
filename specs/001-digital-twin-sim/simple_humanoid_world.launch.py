...
<launch>
  <!-- These are the arguments you can pass this launch file, for example:
       ros2 launch simple_humanoid_bringup simple_humanoid_world.launch.py world:=cafe -->
  ...
  <param name="robot_description" 
         command="xacro $(find simple_humanoid_description)/urdf/simple_humanoid.urdf"/>

  <!-- Spawn robot in gazebo -->
  <node pkg="gazebo_ros" type="spawn_entity.py" name="spawn_urdf"
        args="-entity simple_humanoid -topic robot_description -z 1.0"/>
